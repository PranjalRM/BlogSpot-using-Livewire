            ...
            @forelse ($posts as $post)
                ...
                <div class="blog-post border-b mb-5 pb-5 border-gray-200 flex items-center">
                    ...
                    <div class="flex ml-auto">
                        ...
                        <button wire:click.prevent="deleteConfirmation({{ $post->id }})" class="inline-flex justify-center px-4 py-2 text-sm font-medium leading-5 text-white transition duration-150 ease-in-out bg-red-500 border border-transparent rounded-md hover:bg-red-600 focus:outline-none focus:border-red-700 focus:shadow-outline-red active:bg-red-700 cursor-pointer">
                        Delete
                        </button>
                </div>  
            @empty
